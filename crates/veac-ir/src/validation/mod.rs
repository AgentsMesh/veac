...
pub use output_compat::{
    ...
    render_geometry_valid, video_container_compatible, video_delivery_valid, video_settings_valid,
    FFMPEG_INT_MAX, FLAC_MAX_SAMPLE_RATE, MAX_CHANNEL_LAYOUT_BYTES, MAX_DIMENSION,
    MAX_FRAME_PIXELS, MAX_FRAME_RATE, MAX_INPUT_AUDIO_CHANNELS, MAX_INPUT_AUDIO_SAMPLE_RATE,
    MAX_VIDEO_BITRATE, MAX_VIDEO_BUFFER, PCM_MAX_SAMPLE_RATE,
};
